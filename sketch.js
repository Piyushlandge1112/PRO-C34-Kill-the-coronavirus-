...
function draw(){
    ...
    fill("#E7BBDB")
    textSize(30)
    text("Drag The Mouse To Move Doctor And Kill The coronavirus!!",280,30)
...
fill("#6B5DAA")
    textSize(30)
    text("Coronavirus disease (COVID-19) ",35,530)
    ...
    fill("#BA95D0")
    textSize(28)
    text("Design by Piyush Digambarkumar Landge",5,560)
